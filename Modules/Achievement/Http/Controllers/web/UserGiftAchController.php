...
/**
     ...
     */
     ...
     public function create(Content $content)
     {
         ...
         return $content->header(trans('admin.create'))->description(trans('admin.description'))->body(view('admin.grid.users.UserGiftAchivement', compact('achievement_id')))->render();
     }
