...
//        }
    ...
    public function searchAgent(Request $request)
    {
        ...
        $agencies = ShippingAgency::withoutGlobalScopes()->with("Countries", "AgencypaymentGateways")->withCount('charges')->whereHas('owner', fn($query) => $query->where('appear_charger_agency', 1))->with('owner')
