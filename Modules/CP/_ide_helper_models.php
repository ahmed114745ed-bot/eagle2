 ...
 * @property int $status 0=>cancel,1=>acceptation
 * @property int $exp
 * @property int $sub_exp
 * @property int $level
 * @property int $sub_level
 * @property string|null $last_active_date
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \App\Models\User $userOne
 * @property-read \App\Models\User $userTwo
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo query()
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereExp($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereLastActiveDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereLevel($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereSubExp($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereSubLevel($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereUserOneId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpInfo whereUserTwoId($value)
 */
	class CpInfo extends \Eloquent {}
}
 ...
 * @property int $user_one_id
 * @property int $user_two_id
 * @property int $status 0=>pending,1=>accept,2=>denid,3=>cancel cp
 * @property string|null $last_active_date
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser query()
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser whereLastActiveDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser whereStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser whereUserOneId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|CpUser whereUserTwoId($value)
 */
	class CpUser extends \Eloquent {}
}
