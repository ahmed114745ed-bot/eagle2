    ...
    <Teleport to="body">
        <Transition name="notification">
            <div
                v-if="show"
                :class="[
                    'fixed z-50 flex items-center px-4 py-3 rounded-lg shadow-lg min-w-[300px]',
                    positionClasses,
                    typeClasses
                ]"
            >
                ...
                <button
                    @click="$emit('close')"
                    class="flex-shrink-0 ml-4 p-1 rounded-lg hover:bg-black/10 transition-colors"
                >
