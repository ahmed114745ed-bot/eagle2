...
Route::prefix('auth')->group(function () {
    Route::post('register-whatsapp', [\Modules\WhatsappAuth\Http\Controllers\WhatsappController::class, 'registerWithWhatsapp']);
    Route::post('forget-password-whatsapp', [\Modules\WhatsappAuth\Http\Controllers\WhatsappController::class, 'resetWhatsapp']);
...
Route::post ('send-code-whatsapp',[\App\Http\Controllers\Api\V2\Auth\RegisterController::class,'sendWhatsAapOtp']);
