    ...
    <div class="all-page">
        <div class="settings-sidebar">
            ...
            <div class="settings-menu">
                ...
                style="background: var(--primary-color); color: var(--text-secondary-color);">{{ __('Agora Settings') }}</button>
                <button onclick="showSection('ZegoSettings')"
                style="background: var(--primary-color); color: var(--text-secondary-color);">{{ __('Zego Settings') }}</button>
            </div>
        </div>
