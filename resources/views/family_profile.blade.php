    ...
    <div class="agency-profile-container">
        ...
        <div class="agency-header">
            <div class="agency-avatar">
                <img src="{{getImagePath( @$family->image ) }}" alt="Agency Logo" class="logo-img">
            </div>
            ...
            <div class="tab-content active" id="members-tab">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-left">{{ __('members') }}</h4>
                    </div>
                        ...
                        <div class="box-body">
                            <table class="data-table table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td class="user-cell">
                                                    <div class="user-avatar">
                                                        <img src="{{ getImagePath(@$familyMember->user->profile->avatar) }}" alt="{{ @$familyMember->user->name }}">
                                                    </div>
                                                    <div class="user-info">
                                ...
                                @else
                                    <tbody>
                                        <tr>
                                            <td colspan="3" class="text-center text-muted">{{ __('No members found.') }}</td>
                                        </tr>
                                    </tbody>
                                @endif
                            </table>
                    ...
                    <div class="pagination-wrapper">
                        {{ $familyMembers->appends(['type' => request('type')])->links('vendor.pagination.default') }}
                    </div>
                </div>
            </div>
