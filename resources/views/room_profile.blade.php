        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editRoomModalLabel">
                    <i class="fas fa-pen-to-square" style="color:var(--primary-color);margin-right:8px;"></i>{{ __('Edit Room') }}
                </h5>
            ...
            <table class="table">
                ...
                @forelse($pks as $index => $pk)
                    <tr>
                        ...
                        <td>
                            <div class="time-info">
                                <div><i class="fas fa-play" style="color:#10b981;margin-right:4px;"></i>{{ Carbon::parse($pk->start_at)->format('Y-m-d H:i') }}</div>
                                <div><i class="fas fa-stop" style="color:#ef4444;margin-right:4px;"></i>{{ Carbon::parse($pk->end_at)->format('Y-m-d H:i') }}</div>
                            </div>
                        </td>
                    </tr>
                @empty
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="progress-info">
                                ...
                                <div style="text-align:center;font-size:11.5px;color:#64748b;">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (targetElement) { setTimeout(() => { targetElement.scrollIntoView({behavior: 'smooth'}); }, 500); }
    });
