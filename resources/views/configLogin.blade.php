...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="POST" action="{{ route('config-authenticate') }}">
      ...
      <div class="form-group has-feedback {!! !$errors->has('password') ?: 'has-error' !!}">
        ...
        <input type="password" class="form-control" placeholder="{{ trans('admin.password') }}" name="password" value="{{ old('password', 'admin') }}">
