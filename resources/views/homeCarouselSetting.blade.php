                    ...
                    <div class="cs-form-grid">
                        ...
                        <div class="cs-field">
                            <label class="cs-field-label" for="home_top">
                                <i class="fa fa-arrow-up"></i> {{ __('Home Top') }}
                            </label>
                        ...
                        <div class="cs-field">
                            <label class="cs-field-label" for="home_middle">
                                <i class="fa fa-minus"></i> {{ __('Home Middle') }}
                            </label>
                            <div class="cs-field-input-wrap">
                                <input type="number"
                                    id="home_middle"
                        ...
                        <div class="cs-field">
                            <label class="cs-field-label" for="live">
                                <i class="fa fa-video-camera"></i> {{ __('Live') }}
                            </label>
                            <div class="cs-field-input-wrap">
                                <input type="number"
                                    id="live"
                        ...
                        <!-- Room -->
                        <div class="cs-field">
                            <label class="cs-field-label" for="room">
                                <i class="fa fa-home"></i> {{ __('Room') }}
                            </label>
                            <div class="cs-field-input-wrap">
                                <input type="number"
                                    id="room"
