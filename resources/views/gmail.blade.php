							...
							<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" height="auto" style="border-collapse:collapse">
								<tbody>
                                    ...
                                    <br>
                                        ...
                                        <br>
                                        <a href="{{ url('https://test.tik-chat.com/admin/request-agencies?id=' . $agency->id ) }}" target="_blank" style="background-color:#50cd89; border-radius:6px; display:inline-block; margin-left:60px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif">الوكاله</a>
						</div>
					</div>
					<!--end::Email template-->
				</div>
