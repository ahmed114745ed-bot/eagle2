    ...
    <form action="{{ route('admin.app.settings.update') }}" method="POST" class="settings-form modern-form">
        ...
        <div class="tm-section">
            <div class="tm-section-header">
                <div class="tm-section-icon" style="background: linear-gradient(135deg, #3b82f6, #0ea5e9);">
            ...
            <div class="tm-fields-grid">
                ...
                <div class="tm-field-card">
                    <div class="tm-field-icon-bar">
                        <div class="tm-field-icon" style="background: linear-gradient(135deg, #6366f1, #818cf8);">
                ...
                <div class="tm-field-card">
                    <div class="tm-field-icon-bar">
                        <div class="tm-field-icon" style="background: linear-gradient(135deg, #f59e0b, #fbbf24);">
