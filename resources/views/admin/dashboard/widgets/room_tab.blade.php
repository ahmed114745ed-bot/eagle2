...
<div id="roomStatsRow" class="row">
    <div class="col-md-3">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('rooms?online=1') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('more') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('live-rooms?online=1') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('more') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('live-rooms?is_live=1') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('more') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('live-rooms?is_live=0') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('more') }}</a>
        </div>
    </div>
</div>
