...
<div class="row g-3">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('agencies?active=true') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('More') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('agencies?created=today') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('More') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('agencies?created=month') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('More') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('users?agencyMembers=1') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('More') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card finance-card">
            ...
            <a href="{{ admin_url('agencies?pending=1') }}"><i class="fa fa-arrow-circle-right"></i> {{ __('More') }}</a>
        </div>
    </div>
