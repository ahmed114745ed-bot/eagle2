                ...
                <div class="modal-body">
                    ...
                    <div class="form-section">
                        ...
                        <input type="url" name="json_url" class="form-control"
                               value="https://sas2suc3.leadercc.com/games/prod_game_list.json"
    ...
    "half_url": "https://..."
                    ...
                    <div class="form-section">
                        ...
                        <select name="game_type" class="form-control">
                            <option value="0">Joyplay</option>
                            <option value="1">OX</option>
                            <option value="2">Bytesun</option>
                            <option value="3">Quantum Nexus</option>
                            <option value="4">Zero Games</option>
                        </select>
                        <div class="section-hint">
                            <i class="fa fa-info-circle"></i>
