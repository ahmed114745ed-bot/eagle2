...
class AdminNewPermission extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $categories = [
            ...
            ['name' => 'Games', 'sort' => 2, 'permissions' => ['games']],
            ['name' => 'BD Management', 'sort' => 3, 'permissions' => ['BD', 'delete-bd-Switch', 'choose-bd-Switch']],
            ['name' => 'Fast orders', 'sort' => 4, 'permissions' => ['request-backgrounds-image', 'gift-VIP-Switch', 'bans', 'close-room', 'special-uuid-requests', 'edit-level', 'gift-store-Switch', 'gift-from-the-store', 'gift-VIP']],
            ['name' => 'Wallet', 'sort' => 5, 'permissions' => ['app-wallet']],
            ['name' => 'charge system', 'sort' => 6, 'permissions' => ['charge-report-Switch', 'add-coins-Switch', 'coin-recharge', 'charge-settings', 'charger-reports']],
            ['name' => 'users', 'sort' => 7, 'permissions' => ['deleted-accounts', 'users', 'user-actions', 'chang-agency-Switch', 'charge-switch', 'invite-switch', 'can-Play-Switch', 'kick-family-Switch', 'kick-agency-Switch', 'complaints', 'delete-user-account-Switch', 'restore-user-account-Switch']],
            ['name' => 'Advertisements', 'sort' => 8, 'permissions' => ['banner', 'splash', 'official-messages', 'advertising-space']],
            ['name' => 'Store', 'sort' => 9, 'permissions' => ['store']],
            ['name' => 'Distinguished identifier', 'sort' => 10, 'permissions' => ['featured-ids', 'details-of-unique-identifiers', 'id-color']],
            ['name' => 'Vip', 'sort' => 11, 'permissions' => ['VIPs', 'vip-gift', 'vip-privilege']],
            ['name' => 'families', 'sort' => 12, 'permissions' => ['families', 'families-level']],
            ['name' => 'Agency System', 'sort' => 13, 'permissions' => ['agency-settings']],
            ['name' => 'Internal Sales System', 'sort' => 14, 'permissions' => ['salary-payment-countries', 'accept-agent-request-switch', 'salary-requests', 'internal-sales-system-report', 'transaction-request-problem','rejected-agent-request-switch']],
            ['name' => 'Host Agencies', 'sort' => 15, 'permissions' => ['reports', 'achieved-Target', 'change-users-agency-Switch', 'delete-agency-Switch', 'agencies', 'host-agencies-report', 'users-Wallet', 'hosts-target', 'hosts', 'host-charge-switch', 'host-chang-agency-Switch', 'host-invite-switch', 'host-can-Play-Switch', 'host-kick-agency-Switch', 'host-kick-family-Switch']],
            ['name' => 'Agency Settings', 'sort' => 16, 'permissions' => ['agencies-join-requests', 'target', 'request-agencies', 'accept-agency', 'refuse-agency', 'request-agency-history']],
            ['name' => 'Charging Agencies', 'sort' => 17, 'permissions' => ['appear-charger-agency', 'charge-agency', 'payment-gat-way','agency-manger-setting', 'Payment-methods-for-shipping-agencies']],
            ['name' => 'Agency Manager', 'sort' => 18, 'permissions' => ['managers']],
            ['name' => 'Room', 'sort' => 19, 'permissions' => ['rooms', 'room-actions', 'room-pin-switch', 'close-room-switch', 'categories', 'room-vip', 'room-background', 'emoji', 'gift', 'room-settings']],
            ['name' => 'Achievements', 'sort' => 20, 'permissions' => ['achievement', 'achievement_level', 'user_achievement_level']],
            ['name' => 'Group chat', 'sort' => 21, 'permissions' => ['group-chat',  'updates_group_chat', 'update_setting_button']],
            ['name' => 'Lucky box', 'sort' => 22, 'permissions' => ['boxes', 'box-use']],
            ['name' => 'Events', 'sort' => 23, 'permissions' => ['event-period', 'weekly-star', 'weekly_star_rewards', 'target-event', 'gift-target-event', 'pk-event', 'pk-event-rewards', 'general-roles', 'event_report']],
            ['name' => 'Reels', 'sort' => 24, 'permissions' => ['Real', 'report-real']],
            ['name' => 'Moment', 'sort' => 25, 'permissions' => ['Moment', 'report-moment']],
            ['name' => 'Employees and Permissions', 'sort' => 26, 'permissions' => ['auth-users', 'roles']],
            ['name' => 'Work Settings', 'sort' => 27, 'permissions' => ['delete-account-details', 'questions', 'country', 'page', 'payment-coin', 'coins', 'exchange', 'gold-coins']],
            ['name' => 'Sensitive Settings', 'sort' => 28, 'permissions' => ['updates', 'config']],
            ['name' => 'System Settings', 'sort' => 29, 'permissions' => ['settings', 'language', 'language-switch', 'daily-prize', 'daily-gift']],
            ['name' => 'Level', 'sort' => 30, 'permissions' => ['level', 'level-interval', 'reward-level-interval']],
            ['name' => 'user parent', 'sort' => 30, 'permissions' => ['user-parent']],
        ];
