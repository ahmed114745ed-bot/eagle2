...
use Utd\Family\Http\Controllers\Dashboard\AdminFamiliesController;
use Utd\Family\Http\Controllers\Dashboard\AdminFAmilyLevelsController;
...
use Utd\Events\Http\Controllers\Dashboard\AdminGeneralRolesController;
use Utd\Events\Http\Controllers\Dashboard\Chargebenefit\AdminChargebenefitController;
use Utd\Events\Http\Controllers\Dashboard\Chargebenefit\AdminChargebenefitRewordsController;
use Utd\Events\Http\Controllers\Dashboard\PeriodEvent\AdminPeriodEventController;
...
Route::middleware('auth:sanctum','verified')->group(function(){
    ...
    //************************** End Events **************************** \\
        ...
        Route::controller(AdminInterestsController::class)->group(function(){
            Route::resource('admin-Interests', AdminInterestsController::class);
            route::get('/Sort-Interests','sort');
