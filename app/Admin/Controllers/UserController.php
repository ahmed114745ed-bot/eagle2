...
class UserController extends MainController
{
    ...
    public function show($id, Content $content,)
    {
        ...
        $userJoinAgencies = UsersJoinedAgency::with(['kickedByApp', 'kickedByAdmin'])->orderByDesc('id')->where('user_id', $id)->with('agency')->when(isset($joinDate), function ($query) use ($joinDate) {
            $query->whereDate('join_date', $joinDate);
        })->paginate(10, ['*'], 'user_agency_page');
