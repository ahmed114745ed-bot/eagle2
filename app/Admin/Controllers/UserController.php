...
class UserController extends MainController
{
    ...
    public function show($id, Content $content)
    {
     ...
     ========================= */
        $userQuery = User::query()->select(['id', 'name', 'uuid', 'special_id', 'type_user', 'country_id', 'di', 'email', 'sender_level', 'received_level', 'phone', 'bio', 'total_diamond_send', 'agency_id', 'family_id', 'can_play', 'transfer_salary', 'online']);
        $with = [
            'images',
