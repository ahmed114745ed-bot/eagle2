    ...
    protected function form()
    {
        ...
        $form->select('type', trans('type'))
            ...
            ->when('room', function (Form $form) {
                ...
                $form->select('event_type', trans('events'))->options(['event' => __('events'), 'pk_event' => __('pk_event'), 'weekly_star' => __('weekly_star'), 'charge_event' => __('charge_event'), 'event_period' => __('event_period'), 'weekly_cp' => __('cp')])->when('event', function (Form $form) {
