...
class ResetUserSalaryController extends MainController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('target', __('charge'))->expand(function ($model) {

            $targets = $model->coinLogs()
                ->whereMonth('created_at', Carbon::now()->month)
                ->whereYear('created_at', Carbon::now()->year)->where('status', 1)
    ...
    protected function detail($id)
    {
        ...
        $show->field('reel_following_type', __('Reel following type'));
        ...
        $show->field('following', __('Following'));
        $show->field('follower', __('Follower'));
        $show->field('friend', __('Friend'));
    ...
    protected function form()
    {
        ...
        $form->text('reel_following_type', __('Reel following type'));
        ...
        $form->number('following', __('Following'));
        $form->number('follower', __('Follower'));
        $form->number('friend', __('Friend'));
