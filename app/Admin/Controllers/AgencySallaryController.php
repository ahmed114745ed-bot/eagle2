...
class AgencySallaryController extends Controller
{
    ...
    {
        $grid = new Grid(new AgencySallary);

        $grid->id('ID');
        $grid->agency_id('agency_id');
    ...
    {
        $show = new Show(AgencySallary::findOrFail($id));
    ...
    {
        $form = new Form(new AgencySallary);
