...
class TestController extends AdminController
{
    ...
    protected function detail($id)
    {
        ...
        $show->field('week_star', __('Week star'));
        ...
        $show->field('super_uid', __('Super uid'));
        ...
        $show->field('commission_proportion', __('Commission proportion'));
        $show->field('fresh_time', __('Fresh time'));
        $show->field('start_hour', __('Start hour'));
        $show->field('end_hour', __('End hour'));
