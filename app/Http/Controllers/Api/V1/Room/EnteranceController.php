...
//    }
    ...
    public function enter_room(Request $request)
    {
        ...
        $black_list = Common::getUserBlackListInRoom($owner_id, $user_id);
        ...
        if($room->room_pass &&  $owner_id != $user_id){
...
//        $this->getRoomTwoLastPk($room->id);
        ...
        $this->updateRoom($user_id, $owner_id, $room);
     ...
     // Common::sendOfficialMessage($clint->id, $body_en,$clint->name, titleAr: $body_ar);
