...
class EnteranceController extends Controller
{
    ...
    public function enter_room(Request $request): JsonResponse
    {
        ...
        if ($ban) {
            return Common::apiResponse(0, __('This room has been closed and you will not be able to enter until the ban is lifted by the room moderators.'), ['ban' => true],400);
        }
