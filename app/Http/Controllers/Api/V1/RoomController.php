...
class RoomController extends Controller
{
    ...
    public function is_admin(Request $request)
    {
        ...
        if (count($adm_arr) > ($roomMax >= Common::getConfig('max_room_admin') ? $roomMax : Common::getConfig('max_room_admin'))) return Common::apiResponse(0, 'room manager is full', null, 403);//if (count($adm_arr) > ($roomMax >= 5 ? $roomMax : 5)) return Common::apiResponse(0, 'room manager is full', null, 403);
