...
class RoomController extends Controller
{
    ...
    public function is_admin(Request $request)
    {
        ...
        if (count($adm_arr) == ($roomMax >= Common::getConfig('max_room_admin') ? $roomMax : Common::getConfig('max_room_admin'))) return Common::apiResponse(0, 'room manager is full', null, 422);
