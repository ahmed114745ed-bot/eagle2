...
class UserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $frame  = empty($this->getUserDress(4, $this->dress_1, 'img2')) ?  $this->getUserDress(4, $this->dress_1, 'img1') : $this->getUserDress(4, $this->dress_1, 'img2');
    ...
    public function getUserDress($type, $dress, $item = 'img1')
    {
        ...
        return $pack && $pack->ware ? $pack->ware->{$item} : null;
    }
}
