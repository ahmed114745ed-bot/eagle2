...
class HistoryAgencyResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $target = UserSallary::join('targets', 'targets.id', '=', 'user_sallaries.target_id')->where('user_sallaries.user_agency_id', $this->id)->where('user_sallaries.year', $year)->where('user_sallaries.month', $month)->sum('targets.diamonds');
