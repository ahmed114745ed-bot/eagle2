...
class CustomNotification
{
    ...
    public static function officialMsg(OfficialMessageAdmin $msg)
    {
        $user_id = $msg->user_id;
        if ($user_id == 0) {
            ...
            foreach ($usersChunk as $chunk) {
                foreach ($chunk as $user) {
                    ...
                    Common::send_firebase_notification($user->notification_id, $title, $body, icon: $icon, data: $data, messageType: 'system-msg');
                }
            }
