...
php artisan db:seed --class=Utd\\Moments\\Database\\Seeders\\MomentViewerTestSeeder
```
...
## 📁 الملفات الرئيسية
```
Controller: packages/utd/moments/src/Http/Controllers/web/MomentViewerController.php
View:       packages/utd/moments/Resources/views/viewer/index.blade.php
Routes:     packages/utd/moments/Routes/web.php
Seeder:     packages/utd/moments/Database/Seeders/MomentViewerTestSeeder.php
```
