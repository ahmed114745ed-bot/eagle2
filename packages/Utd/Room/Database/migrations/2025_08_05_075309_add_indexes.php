...
return new class extends Migration
{
    ...
    {
        try { Schema::table('room_visitors', fn (Blueprint $t) => $t->dropIndex(['room_id'])); } catch (\Exception $e) {}
        try { Schema::table('user_box_gifts', fn (Blueprint $t) => $t->dropIndex(['box_uses_id', 'user_id'])); } catch (\Exception $e) {}
