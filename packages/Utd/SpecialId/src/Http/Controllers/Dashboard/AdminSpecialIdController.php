...
namespace Utd\SpecialId\Http\Controllers\Dashboard;
...
class AdminSpecialIdController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        if ($pack) {
            ...
            if ($pack->expire === 0) {
                return response()->error('العنصر موجود لدى المستخدم و غير قابل للانتهاء');
            }
    ...
    public function special_id_history(Request $request)
    {
