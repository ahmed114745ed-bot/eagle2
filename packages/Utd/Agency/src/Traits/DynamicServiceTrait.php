...
trait DynamicServiceTrait
{
     ...
     * 
     * @return \Utd\Agency\Repositories\ShippingAgencyRepository|null
     */
    protected function getShippingAgencyRepository()
    {
        try {
            if (class_exists(\Utd\Agency\Repositories\ShippingAgencyRepository::class)) {
                return app(\Utd\Agency\Repositories\ShippingAgencyRepository::class);
            }
        } catch (\Exception $e) {
