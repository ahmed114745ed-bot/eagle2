...
use Utd\UsersWallet\Http\Controllers\Api\UsersWalletController;
use Utd\UsersWallet\Http\Controllers\Api\WalletController;
...
Route::middleware(['auth:sanctum', 'checkLatestToken', 'generalBan', 'userBan', 'update.last.seen', 'localization'])->group(function () {
